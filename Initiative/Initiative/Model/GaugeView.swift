...
class GaugeView: UIView {
    ...
    var outerCenterDiscColor = #colorLiteral(red: 0.1048603281, green: 0.137150079, blue: 0.1497618556, alpha: 1)
    var outerCenterDiscWidth: CGFloat = 20
    var innerCenterDiscColor = #colorLiteral(red: 0.1048603281, green: 0.137150079, blue: 0.1497618556, alpha: 1)
    var innerCenterDiscWidth: CGFloat = 5
    
    var needleColor = #colorLiteral(red: 0.1048603281, green: 0.137150079, blue: 0.1497618556, alpha: 1)
...
//        for (index, segment) in segmentColors.enumerated() {
        ...
        for index in 0..<100 {
            ...
            // activate its color
            if index <= valueArea {
                #colorLiteral(red: 0.1048603281, green: 0.137150079, blue: 0.1497618556, alpha: 1).set()
            } else {
                UIColor.white.set()
            }
...
//    
    ...
    func setUp() {
        ...
        needle.bounds = CGRect(x: 0, y: 0, width: needleWidth, height: bounds.height/1.5)
